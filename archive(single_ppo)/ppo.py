# Adapted PPO for Multigrid Environment with compatibility fixes
import os
import random
import time
...
def make_env(env_id, idx, capture_video, run_name, seed=0):
    def thunk():
        ...
        env = MultiGridFlattenObservationWrapper(env)
...
class Agent(nn.Module):
    def __init__(self, envs):
        ...
        # Simple feedforward network for both actor and critic
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            # Handle episode metrics for older Gym versions
            for idx, d in enumerate(done):
                if d:
                    # print(f"global_step={global_step}, env_idx={idx}, episodic_return={info[idx].get('episode', {}).get('r', 0)}")
